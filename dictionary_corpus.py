...
def tokenize(dictionary, path):
    """Tokenizes a text file for training or testing to a sequence of indices format
       ...
       If word is not in vocab file it is replaced with <unk>"""
...
def tokenize_list(dictionary, trial):
    """Tokenizes a list of sentences for training or testing to a sequence of indices format
       We assume that training and test data has <eos> symbols 
       If word is not in vocab file it is replaced with <unk>"""
    ntokens = 0
